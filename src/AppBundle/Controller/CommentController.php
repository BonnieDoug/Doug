...
//    }
     ...
     *
     * @Route("/new", name="blog_comment_new")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="blog_comment_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="blog_comment_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Comment $comment)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('blog_comment_edit', array('id' => $comment->getId()));
        }
     ...
     *
     * @Route("/{id}", name="blog_comment_delete")
     * @Method("DELETE")
     */
